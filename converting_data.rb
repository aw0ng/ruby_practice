...
# things_hash = {"chair" => 75, "book" => 15}
# things_array = [{name: "chair", color: "red", weight: 10}, {name: "book", color: "black", weight: 1}]

#output = {"chair" => {price: 75, color: "red", weight: 10}, "book" => {price: 15, color: "black", weight: 1}}

# i = 0
# while i < things_array.length
#   things_hash[things_array[i][:color][:weight]] = things_array[i]
#   i += 1
# end
# p thing_hash
